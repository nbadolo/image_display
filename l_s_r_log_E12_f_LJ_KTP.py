...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 12 11:08:27 2022
...
# =============================================================================
# Nous representons ici, pour le grand tableau log, l'exès infraouge E_12 en fonction 
...
plt.subplot(2,2,3)
plt.plot(df_l["Teff"], df_l["E12"], 'b+')
plt.plot(df_s["Teff"], df_s["E12"], 'r+')
plt.plot(df_r["Teff"], df_r["E12"], 'k+')
plt.legend(["large table", "the sample", "resolved"])
plt.xlabel('Teff', size=10)
plt.ylabel('E12', size=10)

plt.subplot(2,2,4)
plt.plot(df_l["P"], df_l["E12"], 'b+')
plt.plot(df_s["P"], df_s["E12"], 'r+')
plt.plot(df_r["P"], df_r["E12"], 'k+')
plt.legend(["large table", "the sample"])
