...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 21 16:55:10 2022
...
#return Ell_rot.ravel() # .ravel permet de passer de deux dimension à une seule
          ...
          plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/log/SW_Col/plots/fits/linear_scale/' +'white_ellips_contour_at_' + strs[j] + '.pdf', 
                      dpi=100, bbox_inches ='tight')
        
        
          plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/log/SW_Col/plots/fits/linear_scale/' +'white_ellips_contour_at_' + strs[j] +  '.png', 
              dpi=100, bbox_inches ='tight')
          plt.tight_layout()
        ...
        #plt.grid(color='lightgray',linestyle='--')
          plt.show()
          plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/log/SW_Col/plots/fits/linear_scale/' +'real_image_contour_at_' + strs[j] + '.pdf', 
                        dpi=100, bbox_inches ='tight')


          plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/log/SW_Col/plots/fits/linear_scale/' +'real_image_contour_at_' + strs[j] +  '.png', 
                dpi=100, bbox_inches ='tight')
          plt.tight_layout()
          ...
          plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/log/SW_Col/plots/fits/linear_scale/' +'full_image_and_contour_at_' + strs[j] + '.pdf', 
                      dpi=100, bbox_inches ='tight')
        
        
          plt.savefig('/home/nbadolo/Bureau/Aymard/Donnees_sph/log/SW_Col/plots/fits/linear_scale/' +'full_image_and_contour_at_' + strs[j] +  '.png', 
              dpi=100, bbox_inches ='tight')
          plt.tight_layout()
