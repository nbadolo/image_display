...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  4 09:16:19 2022

@author: nbadolo
"""

"""
Code simplifié de 17_lep et de sa psf: flux et profile avec correction du beam 
shift
"""
...
#%%
plt.figure('I_PRIM(avec correction du beam shift)')
plt.clf()
for i in range (nFrames):   
    plt.subplot(3,4,i+1)
    if i==3 or i==7:
