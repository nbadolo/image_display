...
plt.savefig('/home/nbadolo/Bureau/Aymard/These/for_papers/plots/log_paper_plots/' + 'l_s_log_E_IR.pdf', 
                dpi=100, bbox_inches ='tight')


plt.savefig('/home/nbadolo/Bureau/Aymard/These/for_papers/plots/log_paper_plots/' + 'l_s_log_E_IR.png', 
                dpi=100, bbox_inches ='tight')
plt.tight_layout()
plt.show()